...
import createTerminalHooks from './createTerminalHooks';

const { RNStripeTerminal } = NativeModules;

console.log(
  '--- WTF ',
  RNStripeTerminal.DiscoveryMethodBluetoothScan,
...
class StripeTerminal {
  ...
  startService(options) {
    ...
    this._currentService = new ConnectionService({
      terminal: this,
      ...options,
    });
...
} = createTerminalHooks(StripeTerminal_);
