...
module.exports = {
  getBlacklistRE() {
    return blacklist([
      /sailor\/examples\/(?!NavigationPlayground).*/,
      /sailor\/node_modules\/react-native\/(.*)/,
      /sailor\/node_modules\/react\/(.*)/,
      /sailor\/node_modules\/react-native-paper\/(.*)/,
      /sailor\/node_modules\/@expo\/vector-icons\/(.*)/,
    ]);
  },
