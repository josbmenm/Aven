...
function Privacy({}) {
  return (
    <React.Fragment>
      ...
      <Body>
        We at Ono Food Co. know you care about how your personal information is
        ...
        following ways. By using or accessing the Services in any manner, you
        ...
        share your information in the following ways. Remember that your use of
        Ono Food Co’s Services is at all times subject to the Terms of Use,
      ...
      <SubSection title="What does our Privacy Policy cover?">
        <Body>
          ...
          identifiable information ("Personal Information") that we gather when
          ...
          provide, and improve our products and services, develop new products
          and services, to allow you to set up a user account and profile, to
          contact you and allow other users to contact you, to fulfill your
          requests for certain products and services, to analyze how you use the
          Services, and for other internal business purposes. In certain cases,
          we may also share some Personal Information with third parties, but
          only as described below. As noted in the Terms of Service
          ...
          that a child under 13 may have provided us with personal information,
          please contact us at support@onofood.co
        </Body>
      </SubSection>
      ...
      <SubSection title="Information you provide">
        <Body>
          Ono Food Co. receives and stores any information you knowingly provide
          to us. An example of this would be, if you provide your email when
          checking out from our ordering kiosks. Specific information may be
          required to register with us or to take advantage of some of our
          Services. We may communicate with you if you’ve provided us the means
          to do so. For example, if you’ve given us your email address, we may
          email you promotional offers on behalf of our business, or email you
        ...
        <Body>
          ...
          your preference by letting us know that you no longer wish to receive
          such communications by clicking on the unsubscribe option in our
          emails or contacting us at support@onofood.co.
        </Body>
      </SubSection>
      <SubSection title="Information we collect automatically">
        <Body>
          ...
          device, when you click on ads that appear on the Services.
          Additionally, if you click on a link to a third party website or
          service, such third party may also transmit cookies to you. Again,
          this Privacy Policy does not cover the use of cookies by any other
          third parties, and we aren’t responsible for their privacy policies
          and practices. We may use this data to customize content for you that
          we think you might like, based on your usage patterns. We may also use
          it to improve the Services - for example, this data can tell us how
          often users use a particular feature of the Services, and we can use
          that information to make our Services engaging to as many users as
          possible.
        </Body>
      </SubSection>
      <SubSection title="Do we share any of the personal information we receive?">
        <Body>
          ...
          may share your Personal Information with third parties to provide the
          services to you through our website and mobile app:
        </Body>
        <Body>
          We may use third-party analytics services, such as Google Analytics
          and Google Analytics Remarketing and Advertising Reporting Feature, to
          grow our business, to improve our Services, to monitor and analyze the
          use of our Services, to help our tech administration, to ensure that
          users have the authorization they need for us to process their
          requests, and to advertise online. These services may collect and
          retain some information about you. Google Analytics collects the IP
          address assigned to you on the date you use the Services for example,
          but not your name or other personal information.
        </Body>
      </SubSection>
      <SubSection title="Questions about our Privacy Policy?">
        <Body>
          If you have any questions or concerns, email us at support@onofood.co,
          and we will answer your inquiry as soon as possible.
        </Body>
      </SubSection>
    </React.Fragment>
  );
...
PrivacyPage.path = 'legal/privacy';
PrivacyPage.navigationOptions = {
