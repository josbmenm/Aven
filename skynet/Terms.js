...
function Terms({}) {
  return (
    <React.Fragment>
      ...
      <Body>
        <Bold>Effective Date:</Bold> May 27th, 2019
      </Body>
      <Body>
        ...
        services accessible at our mobile food facility, via our Site, and via
        the App. To make these Terms easier to read, the Site, the App, the
        robotic kitchen and related services are collectively called the
        “Services.” If you have any questions, concerns, or comments regarding
        these terms or the Services, please contact us via email at
        support@onofood.co, or through a written letter sent to our physical
        address: 915 Venice Blvd. Los Angeles, CA 90015.
      </Body>
      <Body>
        These Terms are a binding contract between you and Ono Food Co., doing
        business as Ono Blends (“Ono Blends”, “we”, “us”, or “our”). You must
        agree to and accept all of the Terms, or you don’t have the right to use
        the Services. Your using the Services in any way means that you agree to
        ...
        well as those in the Privacy Policy (http://onofood.co/legal/privacy).
      </Body>
      <SubSection title="Modification">
        <Body>
          We are constantly trying to improve our Services, and so these Terms
          may change at any time, in Ono Food Co’s sole discretion. If we do so,
          we’ll let you know either by posting the modified Terms on our Site or
          through other communications. The amended Terms will have immediate
          effect. Your continued use of the Services following the posting of
          any changes to the Terms constitutes your acceptance of such changes.
          The most updated version of these Terms is available at
          onofood.co/legal. Ono Food Co’s Services are evolving, and hence it
          may suspend, modify or discontinue, temporarily or permanently, the
          Services from time to time without notice, and in our sole discretion.
          You agree that Ono Food Co. will not be liable to you or any third
          party as a result of such suspension, modification or discontinuation.
        </Body>
        <Body>
      ...
      <SubSection title="Our Services">
        <Body>
          Ono Food Co. is a robotic food truck that is called “Ono Blends”, and
          it provides its customers smoothies and coffee. You can order your
          smoothie when you’re on-site at our ordering kiosk. At our ordering
          kiosk you select and enter the details of your order, and some other
          relevant information such as your name, phone number, email address,
          and credit card information (such information, “Order Details”). When
          your smoothie or coffee is ready, we will display your name that you
          entered on the ordering kiosk, so that you can grab your beverage at
          the designated pick-up area. Please note that if your beverage will
          not sit on at the pick-up area for longer than 3-minutes after
          displaying your name. If you fail to pick-up your order within
          3-minutes of displaying your name on our status display, you will have
          to pick it up from our counter or you will have to have one of our
          employees re-order your beverage for you.
        </Body>
      </SubSection>
      <SubSection title="Registration & Your Information">
        <Body>
          ...
          information that your privacy settings on the SNS Account permit us to
          access. You agree to (1) provide true, accurate, current and complete
          data about yourself on the Ono Food Co registration form when you
          create an Account (“Registration Data”) and (2) promptly update the
          Registration Data to keep it true, accurate, current and complete. If
          you fail to do any of these things, Ono Food Co. will have the right
          to suspend or terminate your Account and your use of the Services. You
          will be required to create a password as part of your Account creation
          process. You are solely responsible for maintaining the
          confidentiality of your password and Account, and for all use of your
          password and Account, whether authorized by you or not. You agree to
          (a) immediately notify Ono Food Co. via email at support@onofood.co of
          any unauthorized use of your password or Account or any other breach
          of security and (b) ensure that you properly exit or log out from your
          Account each time you use the Services.
        </Body>
      </SubSection>
      <SubSection title="Eligibility">
        <Body>
          ...
          are under 13. You may use the Services only if you are 13 years or
          older and are not barred from using the Services under applicable law.
        </Body>
        <Body>
      ...
      <SubSection title="Payment">
        <Body>
          When you place an order with us through our ordering kiosk of via the
          App, we will provide you the price of the smoothies and other items
          you have ordered. By clicking the “Place Order” button on the ordering
          kiosk or App, you are confirming your order and agreeing to pay the
          price of the items you have ordered. You authorize Ono Food Co or its
          third party payment processor to charge your credit card or other form
          of payment for the price of the beverages and other items that you
          have ordered and confirmed.
        </Body>
        <Body>We accept the following forms of payment:</Body>
        <List>
      ...
      <SubSection title="Return Policy">
        <Body>
          If you don’t like your beverage for any reason at all, we will return
          it free of charge. To do so, please contact support@onofood.co
        </Body>
      </SubSection>
      <SubSection title="Communications & Feedback">
        ...
        <Body>
          ...
          other types of messages via text message (“Messages”). Please be aware
          that third party messaging fees may occur for some of the Messages
          depending on the message plan you have with your wireless carrier. By
          providing your cellular phone number as part of the registration
          process, you are agreeing to receive communications from Ono Food Co.,
          and you specifically authorize Ono Food Co. to send text messages to
          your mobile phone.
        </Body>
      </SubSection>
      <SubSection title="Content & Content Rights ">
        <Body>
          ...
          “User Content” means any Content that Account holders (including you)
          provide to be made available through the Services including without
          limitation, the Order Details. Content includes without limitation
          User Content.
        </Body>
      </SubSection>
      <SubSection title="Ownership, Responsibility, & Removal ">
        <Body>
          ...
          foregoing, Ono Food Co., and its licensors exclusively own all right,
      ...
      <SubSection title="Rights in User Content Granted by You ">
        <Body>
          ...
          providing, and improving our Services and providing Content to you.
          You are solely responsible for all your User Content. You represent
          and warrant that: (i) you own all your User Content or you have all
          rights that are necessary to grant us the license rights in your User
          Content under these Terms; (ii) neither your User Content, nor your
          use and provision of your User Content to be made available through
          the Services, nor any use of your User Content by us on or through the
          ...
          you will comply with these Terms. You can remove your User Content by
          ...
          copies of your User Content may continue to exist on the Services. We
      ...
      <SubSection title="Rights in Services & Content Granted by Us">
        <Body>
          Subject to your compliance with these Terms, Ono Food Co. grants you a
          limited, non-exclusive, non-transferable, non-sublicensable license to
          download, view, copy, display and print the Content solely in
          connection with your permitted use of the Services and solely for your
          personal and non-commercial purposes. In addition, subject to your
          compliance with these Terms, Ono Food Co. grants you the right to use
          the Services solely for your personal and non-commercial use. Unless
          otherwise agreed to in writing by Ono Food Co., you agree that you
          will not use the Services or duplicate, download, publish, modify or
          otherwise distribute or use any material included in the Services for
          any purpose, except to review the information included in the
          Services, to subscribe to programs included in the Services, and to
          purchase the services or products offered by Ono Food Co. for your
          personal use.
        </Body>
      </SubSection>
      <SubSection title="General Prohibitions & Ono Food Co’s Enforcement Rights ">
        <Body>You agree not to do any of the following:</Body>
        <List>
          <ListItem>
            Post, upload, publish, submit or transmit any Content that: (i)
            infringes a third party’s intellectual property rights or rights of
            privacy or publicity, (ii) violates, or encourages any conduct that
            would violate, any applicable law or regulation or would give rise
            to civil liability, or (iii) is fraudulent, false, misleading or
            deceptive;{' '}
          </ListItem>
          <ListItem>
            Use, display, mirror or frame the Services or any individual element
            within the Services, Ono Food Co or Ono Blend’s name, any Ono Food
            Co. trademark, logo or other proprietary information, or the layout
            and design of any page or form contained on a page, without Ono Food
            Co’s express written consent;{' '}
          </ListItem>
          <ListItem>
            Access, tamper with, or use non-public areas of the Services, Ono
            Food Co’s computer systems, or the technical delivery systems of Ono
            Food Co’s providers;{' '}
          </ListItem>
          <ListItem>
            Attempt to probe, scan or test the vulnerability of any Ono Food Co.
            system or network or breach any security or authentication measures;{' '}
          </ListItem>
          <ListItem>
            Avoid, bypass, remove, deactivate, impair, descramble or otherwise
            circumvent any technological measure implemented by Ono Food Co. or
            any of Ono Food Co.’s providers or any other third party (including
        ...
        <Body>
          ...
          cooperating with law enforcement authorities to prosecute users who
          violate the law.
        </Body>
      </SubSection>
      <SubSection title="Warranty Disclaimer">
        <Body>
          YOUR USE OF THE SERVICE IS AT YOUR SOLE RISK AND IS PROVIDED ON AN ‘AS
          IS’ AND ‘AS AVAILABLE’ BASIS. THE SERVICES ARE FOR YOUR PERSONAL USE
          ONLY AND WE MAKE NO REPRESENTATION OR WARRANTY OF ANY KIND, EXPRESS OR
          IMPLIED. WE DO NOT ENDORSE, WARRANT OR GUARANTEE ANY MATERIAL, PRODUCT
          OR SERVICE OFFERED THROUGH US OR THE SERVICES. WITHOUT LIMITING THE
          FOREGOING, ONO FOOD CO. DISCLAIMS ANY WARRANTIES OF MERCHANTABILITY,
          FITNESS FOR A PARTICULAR PURPOSE, QUIET ENJOYMENT, AND
          NON-INFRINGEMENT, AND ANY WARRANTIES ARISING OUT OF COURSE OF DEALING
          OR USAGE OF TRADE. ONO FOOD CO. FURTHER DISCLAIMS ANY WARRANTY THAT
          THE SERVICES WILL BE UNINTERRUPTED, BE FREE FROM INACCURACIES, ERRORS,
          VIRUSES OR OTHER HARMFUL COMPONENTS, OR MEET YOUR REQUIREMENTS.
        </Body>
      </SubSection>
      <SubSection title="Limitation of Liability">
        <Body>
          TO THE EXTENT PERMITTED BY LAW, ONO FOOD CO. AND ITS SUBSIDIARIES AND
          LICENSORS WILL NOT BE LIABLE TO YOU OR ANY THIRD PARTY FOR ANY DIRECT,
          INDIRECT, PUNITIVE, INCIDENTAL, SPECIAL, CONSEQUENTIAL DAMAGES
          (INCLUDING DAMAGES RELATING TO LOST PROFITS, LOST DATA OR LOSS OF
          GOODWILL) OR ANY DAMAGES WHATSOEVER THAT RESULT FROM YOUR USE OF OR
          INABILITY TO USE THE SERVICES. THIS LIMITATION APPLIES WHETHER THE
          ALLEGED LIABILITY IS BASED ON CONTRACT, TORT, NEGLIGENCE, STRICT
          LIABILITY, OR ANY OTHER LEGAL THEORY, AND EVEN IF ONO FOOD CO. HAS
          BEEN ADVISED OF THE POSSIBILITY OF SUCH DAMAGE. WITHOUT LIMITING THE
          FOREGOING, ONO FOOD CO. WILL NOT BE LIABLE FOR ANY LOSS OR DAMAGE
          ARISING OUT OF YOUR FAILURE TO COMPLY WITH THE “REGISTRATION, ACCOUNTS
          AND PASSWORDS” SECTION OF THESE TERMS OR YOUR USER CONTENT.IN NO EVENT
          WILL ONO FOOD CO’S TOTAL LIABILITY ARISING OUT OF OR IN CONNECTION
          WITH THESE TERMS OR FROM THE USE OF OR INABILITY TO USE THE SERVICES
          EXCEED THE AMOUNTS YOU HAVE PAID OR ARE PAYABLE BY YOU TO ONO FOOD CO.
          FOR USE OF THE SERVICES IN THE THREE MONTHS PRECEDING THE CLAIM, OR
          ONE HUNDRED DOLLARS ($100), IF YOU HAVE NOT HAD ANY PAYMENT
          OBLIGATIONS TO ONO FOOD CO., AS APPLICABLE.
        </Body>
      </SubSection>
      <SubSection title="Third Party Websites">
        <Body>
          The third party websites linked to or from the Services are not
          controlled by Ono Food Co. and Ono Food Co. is not responsible for the
          contents of such third party websites. Accordingly, Ono Food Co. makes
          no warranties or conditions regarding such third party websites and
          will not be liable for any loss or damage caused by your use of or
          reliance on such websites. Your use of third party websites is at your
          own risk. The inclusion on the Services of a link to third party
          websites are provided solely for your convenience and do not indicate,
          expressly or impliedly, any endorsement by Ono Food Co. for the third
          party websites or the products or services provided at such websites.
        </Body>
      </SubSection>
      <SubSection title="Indemnity">
        <Body>
          ...
          damage, loss, cost or expense (including without limitation, legal and
          attorney’s fees and costs) incurred in connection with any third party
          claim, demand, proceeding or action (“Claim”) brought against any of
          the Indemnified Parties arising out of: (i) your use of the Services,
          (ii) your User Content, or (iii) any alleged breach by you of any
          provision of these Terms. If you are obligated to indemnify Ono Food
          Co., Ono Food Co. may, in its sole and absolute discretion, control
          the defense and disposition (including its possible settlement) of any
          ...
          dispose of any Claim without the written consent of Ono Food Co.
        </Body>
      </SubSection>
      <SubSection title="Termination">
        <Body>
          In its sole and absolute discretion, with or without notice to you,
          Ono Food Co. may (1) suspend or terminate your use of the Service, or
          (2) terminate your Account. You may terminate your Account for any
          reason by emailing Ono Food Co. at support@onofood.co. Ono Food Co.
...
TermsPage.path = 'legal/terms';
TermsPage.navigationOptions = {
  title: 'Terms',
};
